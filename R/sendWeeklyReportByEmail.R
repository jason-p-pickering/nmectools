...
sendWeeklyReportByEmail <- function(d, d2_session) {
  ...
  subject <- paste("Weekly Topup Report for ",
      as.Date(d$report_date) - lubridate::days(7), "-", d$report_date)
...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Topup Summary</title></head><body>',
  as.character(d$facility_summary_table_html), "</>",
